...
void inicializarPulsador( void )
{
    ...
    pulsadorA.cola          = xQueueCreate( 1 , sizeof(EnvioDatos*) ); // Creación de la cola 
...
static void botonLiberado( uint8_t  indice)
{
    ...
    //Terminar la linea siguiente !
    xQueueSend( pulsadorA.cola , &punteroEnvioDatos,  portMAX_DELAY  ); // Envío dato a la la cola
}
